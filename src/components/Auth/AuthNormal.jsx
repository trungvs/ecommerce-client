...
export default function AuthNormal() {
    ...
    return (
        <div className="auth-wrapper" style={{maxWidth: "600px", margin: "100px auto"}}>
            <Toaster position="top-right" />

            {/* Login Form */}
            <Box className="auth-box active" open={login} onClose={handleClose} stlye={styles.Dialog}>
            ...
            {/* Signin Form */}
            <Box className="auth-box" open={signin} onClose={handleSignUpClose} stlye={styles.Dialog}>
                <DialogActions sx={{ p: 0, mt: 2 }}>
                    <Button onClick={handleSignUpClose}><CloseIcon size="large" /></Button>
                </DialogActions>
                <DialogTitle style={styles.DialogTitle}>
                    Đăng Ký
                </DialogTitle>
            ...
            {/* Forget Form */}
            <Box className="auth-box" open={forget} onClose={handleForgetClose} stlye={styles.Dialog}>
                <DialogActions sx={{ p: 0, mt: 2 }}>
                    <Button onClick={handleForgetClose}><CloseIcon size="large" /></Button>
                </DialogActions>
                <DialogTitle style={styles.DialogTitle}>
                    Quên mật khẩu
                </DialogTitle>
